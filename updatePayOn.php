...
<body>
    ...
    <main>
    <h1>Update Pay On's Information</h1>
       <div class="container">
       
        <form  action="updateDataPayOn.php" method="post" name="updatePayOn">
            <div class="form">
            <div class="input-container ic1">
                ...
                //   $objResult = mysqli_fetch_array($objQuery);
                  ?>
                    <select id="BillNo" name="BillNo" class="input" type="text" placeholder="Bill No" >
                    <?php
                          while ($objResult = mysqli_fetch_array($objQuery)) {
                          ?>
                              <option value=<?php echo $objResult["BillNo"]; ?>><?php echo $objResult["BillNo"]; ?></option>
                          <?php
                          }
                          ?>
                      </select>
                    <div class="cut"></div>
                    <label for="BillNo" class="placeholder">BillNo</label>    
                </div> 
                ...
                <?php
                  ...
                  ?>
                    ...
                    <?php
                          while ($objResult = mysqli_fetch_array($objQuery)) {
                          ?>
                              <option value=<?php echo $objResult["LCode"]; ?>><?php echo "สัญญาฉบับที่ ",$objResult["LCode"]," ",$objResult["FName"]," ",$objResult["LName"]; ?></option>
                          <?php
                          }
                          ?>
                      </select>
