...
<head>
    ...
    <link rel="stylesheet" href="insertPay_month.css">
...
<!-- <  link rel="stylesheet" href="insertPay_month.js"> -->
<script>
...
<body>
    ...
    <main>
       <div class="container">
        <h1>Insert Pay Month's Information</h1>
        
        

        <form action="insertdataPay_month.php" method="post" name="PayMonth">
          <table >
          
              <tr >
                  <td class="pay">Pay Date :</td>
                  <td><input type="date" name="payDate" class="paydate" onchange="calculateLastPayDate()"></td>
              </tr>
            
              
              <tr style="border: none;">
                  <td >Last Pay Date :</td>
                  <td><span id="newDate"  name="lastPayDate"></span></td>
              </tr>
